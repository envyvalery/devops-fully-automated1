...
1) ###### GitHub setup
    Fork GitHub Repository by using the existing repo "devops-fully-automated" ([https://github.com/mariusforreal/devops-fully-automated.git](https://github.com/envyvalery/devops-fully-automated1.git)    
